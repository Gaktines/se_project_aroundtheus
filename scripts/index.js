...
function addCardModalPopup() {
  addCardEditModal.classList.remove("#modal_opened");
}
...
profilemodalCloseButton.addEventListener("click", closeModal(editModalPopup));
